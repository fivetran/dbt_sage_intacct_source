...
By default, all variables are assumed to be `true`. You only need to add variables for the tables you would like to disable, in your root `dbt_project.yml` file::
...
- If you have questions or want to reach out for help, please refer to the [GitHub Issue](https://github.com/fivetran/dbt_sage_intacct_source/issues/new/choose) section to find the right avenue of support for you.
