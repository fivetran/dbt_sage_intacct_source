# [DEPRECATED] Sage Intacct Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_sage_intacct`](https://github.com/fivetran/dbt_sage_intacct) instead, which now contains all models previously found here._
